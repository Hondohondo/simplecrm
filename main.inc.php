...
//$query = "SELECT orgid, name, city, state, shortdesc from orgs order by orgid desc limit 0,10";

$query = "SELECT `orgid`, `orgname`,  `city`, `state`, `shortdesc` from orgs order by orgid desc limit 0,10";
...
if(mysqli_num_rows($result) == 0) {
    ...
    while($row=mysqli_fetch_array($result, MYSQLI_ASSOC)) {
        ...
        echo "<a href=\"index.php?content=showcompany&id=$companyid\">$name</a> -- $city, $state<br>\n";
